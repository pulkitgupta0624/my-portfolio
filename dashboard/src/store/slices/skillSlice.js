...
export const getAllSkills = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://my-portfolio-backend-mxnc.onrender.com/api/v1/skill/getall",
...
export const addNewSkill = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://my-portfolio-backend-mxnc.onrender.com/api/v1/skill/add",
      data,
      {
        withCredentials: true,
...
export const updateSkill = (id, proficiency) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `https://my-portfolio-backend-mxnc.onrender.com/api/v1/skill/update/${id}`,
      { proficiency },
      {
        withCredentials: true,
...
export const deleteSkill = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://my-portfolio-backend-mxnc.onrender.com/api/v1/skill/delete/${id}`,
      {
        withCredentials: true,
      }
    );
