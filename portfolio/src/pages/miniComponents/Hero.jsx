...
const Hero = () => {
    ...
    return (
        ...
        sm:text-[1.75rem] md:text-[2.2rem] lg:text-[2.8rem] tracking-[15px]">
                <Typewriter
                    words={["WEB DEVELOPER", "FREELANCER", "ENGINEER"]}
                    loop={50}
                    cursor
                    typeSpeed={70}
                    deleteSpeed={50}
        ...
        items-center mt-4 md:mt-8 lg:mt-10">
                ...
                <Link to={"https://www.geeksforgeeks.org/user/user_kzvzvcugg4a/"} target="_blank">
                    <img src={gfg} alt="" className="w-7 h-7" />
                </Link>
                <Link to={"https://leetcode.com/u/pulkit0624/"} target="_blank">
                    <img src={leetcode} alt="" className="w-7 h-7" />
                </Link>
